...
<head>
    ...
    <link rel="stylesheet" href="frontend/css/plugins/owl-carousel/owl.carousel.css">
    <link rel="stylesheet" href="frontend/css/plugins/jquery.countdown.css">
    <link rel="stylesheet" href="frontend/css/plugins/magnific-popup/magnific-popup.css">
    <!-- Main CSS File -->
    <link rel="stylesheet" href="frontend/css/style.css">
    <link rel="stylesheet" href="frontend/css/skins/skin-demo-24.css">
    <link rel="stylesheet" href="frontend/css/demos/demo-24.css">
...
<body>
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="frontend/images/popup/newsletter/logo.png" class="logo" alt="logo" width="60" height="15">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="frontend/images/popup/newsletter/img-1.jpg" class="newsletter-img" alt="newsletter">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="frontend/js/bootstrap-input-spinner.js"></script>
    <script src="frontend/js/jquery.plugin.min.js"></script>
    <script src="frontend/js/jquery.countdown.min.js"></script>
    <script src="frontend/js/jquery.magnific-popup.min.js"></script>
    <!-- Main JS File -->
    <script src="frontend/js/main.js"></script>
    <script src="frontend/js/demos/demo-24.js"></script>
